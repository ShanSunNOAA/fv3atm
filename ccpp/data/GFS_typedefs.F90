...
!--- SkinSST variables
    ...
    real (kind=kind_phys), pointer :: dtwarm (:)   => null()  !< Sub layer warming amount
    real (kind=kind_phys), pointer :: dtcool (:)   => null()  !< Sub layer cooling amount
    real (kind=kind_phys), pointer :: zsub   (:)   => null()  !< Sub layer cooling thickness
...
!--- Out
    ...
    allocate (Sfcprop%dtwarm  (IM))
    allocate (Sfcprop%dtcool  (IM))
    allocate (Sfcprop%zsub    (IM))
